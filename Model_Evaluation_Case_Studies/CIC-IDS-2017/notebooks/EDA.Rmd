...
thurs <- read_csv("./Model_Evaluation_Case_Studies/CIC-IDS-2017/data/Thursday-WorkingHours-Morning-WebAttacks.pcap_ISCX.csv") %>%
...
```{r principal_component_analysis, eval=FALSE}
