...
```{r}
anomaly_hist(trans_scores$max_all, "Max Value Ensemble - Anomaly Score Distribution")
top_k_label(trans_scores$max_all, "Max Value Ensemble - Score Statistics", T)
draw_pr_curve(trans_scores$max_all, "Max Value Ensemble - Precision/Recall across Scores")
```

### Mean Value 

```{r}
anomaly_hist(trans_scores$mean_all, "Mean Value Ensemble - Anomaly Score Distribution")
top_k_label(trans_scores$mean_all, "Mean Value Ensemble - Score Statistics", T)
draw_pr_curve(trans_scores$mean_all, "Mean Value Ensemble - Precision/Recall across Scores")
```

### Harmonic Mean

```{r}
anomaly_hist(trans_scores$harm_mean_all, "Harmonic Mean Ensemble - Anomaly Score Distribution")
top_k_label(trans_scores$harm_mean_all, "Harmonic Mean Ensemble - Score Statistics", T)
draw_pr_curve(trans_scores$harm_mean_all, "Harmonic Mean Ensemble - Precision/Recall across Scores")
```

### Mean of Top 2 Scores

```{r}
anomaly_hist(trans_scores$mean_top2, "Top 2 Mean Ensemble - Anomaly Score Distribution")
top_k_label(trans_scores$mean_top2, "Top 2 Mean Ensemble - Score Statistics", T)
draw_pr_curve(trans_scores$mean_top2, "Top 2 Mean Ensemble - Precision/Recall across Scores")
```

### Harmonic Mean of Top 2 Scores

```{r}
anomaly_hist(trans_scores$harm_mean_top2, "Top 2 Harmonic Mean Ensemble - Anomaly Score Distribution")
top_k_label(trans_scores$harm_mean_top2, "Top 2 Harmonic Mean Ensemble - Score Statistics", T)
draw_pr_curve(trans_scores$harm_mean_top2, "Top 2 Harmonic Mean Ensemble - Precision/Recall across Scores")
```
